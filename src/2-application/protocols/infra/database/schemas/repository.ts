...
> {
	...
	abstract update(params: RepositoryProtocol.Update.Params<T>): RepositoryProtocol.Update.Result<T>;
	abstract delete(params: RepositoryProtocol.Delete.Params<T>): RepositoryProtocol.Delete.Result;
}
